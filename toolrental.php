        ...
        <div class="tool-1">
          <?php if (!empty($categories)) : ?>
            <?php foreach ($categories as $category) : ?>
              <div class="tool">
                <p class="category"><?php echo $category['cname']; ?></p>
                <img src="<?php echo $category['cimg']; ?>" class="toolimg" alt="logo/2.png">
                <br>
                <form action="tools.php" method="get">
                  <input type="hidden" name="title" value="<?php echo $category['cname']; ?>">
                  <button class="explore" name="find-tool">Explore All</button>
                </form>
              </div>
            <?php endforeach; ?>
          <?php else : ?>
    ...
    <footer class="footer">
      ...
      <div>
        <ul class="socialmedia-list">
          <li><i class="fi-brands-facebook facebook"></i></li>
          <li><i class="uil uil-linkedin linkedin"></i></li>
