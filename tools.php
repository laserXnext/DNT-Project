...
<body>
        ...
        <section class="tools">
            <?php foreach ($tools as $tool) : ?>
                <div class='tool-ex'>
                    <img src=<?php echo $tool['timg']; ?> class='toolimg-ex'>
                    <div class='details'>
                        <p class='tool-name'><?php echo $tool['toolname']; ?> - 
                        <a class='more-data'><?php echo ($tool['availability'] == 1) ? 'Available' : 'Unavailable'; ?></a></p>
                        <p class='tool-desc'><?php echo $tool['description']; ?></p>
                        <div class='pricing'>
                            <ul class='time-list'>
                                <li>Day</li>
                                <li>Week</li>
                            ...
                            <ul class='price-list'>
                                <li>Rs.<?php echo $tool['price-d']; ?></li>
                                <li>Rs.<?php echo $tool['price-w']; ?></li>
                                <li>Rs.<?php echo $tool['price-m']; ?></li>
                            </ul>
                        </div>
                    </div>
                </div>;
